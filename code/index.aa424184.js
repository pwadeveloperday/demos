...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}return(t=r[Symbol.iterator]()).next.bind(t)}try{self["workbox:core:6.5.2"]&&_()}catch{}var Re=function(){var r=this;this.promise=new Promise(function(e,t){r.resolve=e,r.reject=t})};function Be(r,e){var t=location.href;return new URL(r,t).href===new URL(e,t).href}var V=function(r,e){this.type=r,Object.assign(this,e)};function X(r,e,t){return t?e?e(r):r:(r&&r.then||(r=Promise.resolve(r)),e?r.then(e):r)}function vn(){}var gn={type:"SKIP_WAITING"};function Ut(r,e){if(!e)return r&&r.then?r.then(vn):Promise.resolve()}var _n=function(r){var e,t;function n(c,a){var l,p;return a===void 0&&(a={}),(l=r.call(this)||this).nn={},l.tn=0,l.rn=new Re,l.en=new Re,l.on=new Re,l.un=0,l.an=new Set,l.cn=function(){var u=l.fn,h=u.installing;l.tn>0||!Be(h.scriptURL,l.sn.toString())||performance.now()>l.un+6e4?(l.vn=h,u.removeEventListener("updatefound",l.cn)):(l.hn=h,l.an.add(h),l.rn.resolve(h)),++l.tn,h.addEventListener("statechange",l.ln)},l.ln=function(u){var h=l.fn,d=u.target,E=d.state,L=d===l.vn,N={sw:d,isExternal:L,originalEvent:u};!L&&l.mn&&(N.isUpdate=!0),l.dispatchEvent(new V(E,N)),E==="installed"?l.wn=self.setTimeout(function(){E==="installed"&&h.waiting===d&&l.dispatchEvent(new V("waiting",N))},200):E==="activating"&&(clearTimeout(l.wn),L||l.en.resolve(d))},l.dn=function(u){var h=l.hn,d=h!==navigator.serviceWorker.controller;l.dispatchEvent(new V("controlling",{isExternal:d,originalEvent:u,sw:h,isUpdate:l.mn})),d||l.on.resolve(h)},l.gn=(p=function(u){var h=u.data,d=u.ports,E=u.source;return X(l.getSW(),function(){l.an.has(E)&&l.dispatchEvent(new V("message",{data:h,originalEvent:u,ports:d,sw:E}))})},function(){for(var u=[],h=0;h<arguments.length;h++)u[h]=arguments[h];try{return Promise.resolve(p.apply(this,u))}catch(d){return Promise.reject(d)}}),l.sn=c,l.nn=a,navigator.serviceWorker.addEventListener("message",l.gn),l}t=r,(e=n).prototype=Object.create(t.prototype),e.prototype.constructor=e,e.__proto__=t;var i,s,o=n.prototype;return o.register=function(c){var a=(c===void 0?{}:c).immediate,l=a!==void 0&&a;try{var p=this;return function(u,h){var d=u();return d&&d.then?d.then(h):h(d)}(function(){if(!l&&document.readyState!=="complete")return Ut(new Promise(function(u){return window.addEventListener("load",u)}))},function(){return p.mn=Boolean(navigator.serviceWorker.controller),p.yn=p.pn(),X(p.bn(),function(u){p.fn=u,p.yn&&(p.hn=p.yn,p.en.resolve(p.yn),p.on.resolve(p.yn),p.yn.addEventListener("statechange",p.ln,{once:!0}));var h=p.fn.waiting;return h&&Be(h.scriptURL,p.sn.toString())&&(p.hn=h,Promise.resolve().then(function(){p.dispatchEvent(new V("waiting",{sw:h,wasWaitingBeforeRegister:!0}))}).then(function(){})),p.hn&&(p.rn.resolve(p.hn),p.an.add(p.hn)),p.fn.addEventListener("updatefound",p.cn),navigator.serviceWorker.addEventListener("controllerchange",p.dn),p.fn})})}catch(u){return Promise.reject(u)}},o.update=function(){try{return this.fn?Ut(this.fn.update()):void 0}catch(c){return Promise.reject(c)}},o.getSW=function(){return this.hn!==void 0?Promise.resolve(this.hn):this.rn.promise},o.messageSW=function(c){try{return X(this.getSW(),function(a){return It(a,c)})}catch(a){return Promise.reject(a)}},o.messageSkipWaiting=function(){this.fn&&this.fn.waiting&&It(this.fn.waiting,gn)},o.pn=function(){var c=navigator.serviceWorker.controller;return c&&Be(c.scriptURL,this.sn.toString())?c:void 0},o.bn=function(){try{var c=this;return function(a,l){try{var p=a()}catch(u){return l(u)}return p&&p.then?p.then(void 0,l):p}(function(){return X(navigator.serviceWorker.register(c.sn,c.nn),function(a){return c.un=performance.now(),a})},function(a){throw a})}catch(a){return Promise.reject(a)}},i=n,(s=[{key:"active",get:function(){return this.en.promise}},{key:"controlling",get:function(){return this.on.promise}}])&&dn(i.prototype,s),n}(function(){function r(){this.Pn=new Map}var e=r.prototype;return e.addEventListener=function(t,n){this.Sn(t).add(n)},e.removeEventListener=function(t,n){this.Sn(t).delete(n)},e.dispatchEvent=function(t){t.target=this;for(var n,i=fn(this.Sn(t.type));!(n=i()).done;)(0,n.value)(t)},e.Sn=function(t){return this.Pn.has(t)||this.Pn.set(t,new Set),this.Pn.get(t)},r}());function mn(r={}){const{immediate:e=!1,onNeedRefresh:t,onOfflineReady:n,onRegistered:i,onRegisterError:s}=r;let o;const c=async(a=!0)=>{};return"serviceWorker"in navigator&&(o=new _n("/sw.js",{scope:"/",type:"classic"}),o.addEventListener("activated",a=>{a.isUpdate?window.location.reload():n==null||n()}),o.register({immediate:e}).then(a=>{i==null||i(a)}).catch(a=>{s==null||s(a)})),c}var yn=Object.defineProperty,wn=Object.getOwnPropertyDescriptor,bn=(r,e,t,n)=>{for(var i=n>1?void 0:n?wn(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&yn(e,t,i),i};let Ht=class extends v{static get styles(){return m`
    ...
    `}};Ht=bn([y("app-home")],Ht);var $n=Object.defineProperty,En=Object.getOwnPropertyDescriptor,ir=(r,e,t,n)=>{for(var i=n>1?void 0:n?En(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&$n(e,t,i),i};let je=class extends v{constructor(){super(),this.enableBack=!1}static get styles(){return m`
     header {
    ...
    `}};ir([f({type:Boolean})],je.prototype,"enableBack",2);je=ir([y("app-header")],je);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */class Ue extends Pn{constructor(e){if(super(e),this.it=b,e.type!==An.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===b||e==null)return this.ft=void 0,this.it=e;if(e===R)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ue.directiveName="unsafeHTML",Ue.resultType=1;const $=Cn(Ue);var Ln=Object.defineProperty,xn=Object.getOwnPropertyDescriptor,Ve=(r,e,t,n)=>{for(var i=n>1?void 0:n?xn(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&Ln(e,t,i),i};let oe=class extends v{constructor(){super(),this.enableBack=!1,this.svg=`
  ...
  `}static get styles(){return m`
    ...
    `}render(){return g`
    ${$(this.svg)}
    `}};Ze([f({type:Boolean})],ce.prototype,"enableBack",2);Ze([f({type:String})],ce.prototype,"svg",2);ce=Ze([y("icon-mac")],ce);var Dn=Object.defineProperty,In=Object.getOwnPropertyDescriptor,qe=(r,e,t,n)=>{for(var i=n>1?void 0:n?In(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&Dn(e,t,i),i};let he=class extends v{constructor(){super(),this.enableBack=!1,this.svg=`
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
  ...
  `}static get styles(){return m`
    ...
    `}render(){return g`
    ${$(this.svg)}
    `}};qe([f({type:Boolean})],he.prototype,"enableBack",2);qe([f({type:String})],he.prototype,"svg",2);he=qe([y("icon-win")],he);var jn=Object.defineProperty,Un=Object.getOwnPropertyDescriptor,Ke=(r,e,t,n)=>{for(var i=n>1?void 0:n?Un(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&jn(e,t,i),i};let pe=class extends v{constructor(){super(),this.enableBack=!1,this.svg=`
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
  ...
  `}static get styles(){return m`
    ...
    `}constructor(){super()}firstUpdated(){var e;new S((e=this.shadowRoot)==null?void 0:e.querySelector("#routerOutlet")).setRoutes([{path:"",animate:!0,children:[{path:"/",component:"app-home"},{path:"/about",component:"app-about",action:async()=>{await w(()=>import("./app-about.600d2398.js"),[])}},{path:"/sample/notification",component:"sample-n",action:async()=>{await w(()=>import("./sample-n.4edeeed0.js"),[])}},{path:"/sample/url-protocol-handler",component:"sample-uph",action:async()=>{await w(()=>import("./sample-uph.9663ca89.js"),["code/sample-uph.9663ca89.js","code/query.0830c8af.js"])}},{path:"/sample/wake-lock",component:"sample-swl",action:async()=>{await w(()=>import("./sample-swl.e8a6d802.js"),["code/sample-swl.e8a6d802.js","code/query.0830c8af.js"])}},{path:"/sample/async-clipboard",component:"sample-ac",action:async()=>{await w(()=>import("./sample-ac.295323cb.js"),["code/sample-ac.295323cb.js","code/query.0830c8af.js"])}},{path:"/sample/contact-picker",component:"sample-c",action:async()=>{await w(()=>import("./sample-c.ac7c43e3.js"),["code/sample-c.ac7c43e3.js","code/query.0830c8af.js"])}},{path:"/sample/generic-sensor",component:"sample-gs",action:async()=>{await w(()=>import("./sample-gs.54b13510.js"),["code/sample-gs.54b13510.js","code/query.0830c8af.js"])}},{path:"/sample/shape-detection",component:"sample-sd",action:async()=>{await w(()=>import("./sample-sd.8ea78969.js"),["code/sample-sd.8ea78969.js","code/query.0830c8af.js"])}},{path:"/sample/app-shortcuts",component:"sample-as",action:async()=>{await w(()=>import("./sample-as.36542074.js"),[])}},{path:"/sample/badging",component:"sample-b",action:async()=>{await w(()=>import("./sample-b.9cde5e85.js"),["code/sample-b.9cde5e85.js","code/query.0830c8af.js"])}},{path:"/sample/eyedropper",component:"sample-ed",action:async()=>{await w(()=>import("./sample-ed.9d25948c.js"),["code/sample-ed.9d25948c.js","code/query.0830c8af.js"])}},{path:"/sample/window-controls-overlay",component:"sample-wco",action:async()=>{await w(()=>import("./sample-wco.df4cfc0e.js"),["code/sample-wco.df4cfc0e.js","code/query.0830c8af.js"])}},{path:"/sample/web-share",component:"sample-ws",action:async()=>{await w(()=>import("./sample-ws.f4df8268.js"),["code/sample-ws.f4df8268.js","code/query.0830c8af.js"])}},{path:"/sample/local-font-access",component:"sample-lfa",action:async()=>{await w(()=>import("./sample-lfa.b13ea1d1.js"),["code/sample-lfa.b13ea1d1.js","code/query.0830c8af.js"])}},{path:"/sample/file-handling",component:"sample-fh",action:async()=>{await w(()=>import("./sample-fh.8d5da41f.js"),["code/sample-fh.8d5da41f.js","code/query.0830c8af.js"])}},{path:"/sample/media-player",component:"sample-mp",action:async()=>{await w(()=>import("./sample-mp.7eabe6d4.js"),["code/sample-mp.7eabe6d4.js","code/lit-video.6fc33520.js","code/query.0830c8af.js"])}},{path:"/sample/file-system-access",component:"sample-fsa",action:async()=>{await w(()=>import("./sample-fsa.96562fe3.js"),["code/sample-fsa.96562fe3.js","code/lit-video.6fc33520.js","code/query.0830c8af.js"])}},{path:"/sample/navigation",component:"sample-na",action:async()=>{await w(()=>import("./sample-na.659ad793.js"),["code/sample-na.659ad793.js","code/query.0830c8af.js"])}},{path:"/code-of-conduct",component:"app-coc",action:async()=>{await w(()=>import("./app-coc.6f98d01e.js"),[])}},{path:"/privacy",component:"app-privacy",action:async()=>{await w(()=>import("./app-privacy.9921b4b5.js"),[])}}]}]),mn({immediate:!0})}render(){return g`
...
//# sourceMappingURL=index.aa424184.js.map
