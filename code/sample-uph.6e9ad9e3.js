import{s as d,r as p,$ as g,n as h}from"./index.8489cdff.js";import{i as n}from"./query.0830c8af.js";var m=Object.defineProperty,u=Object.getOwnPropertyDescriptor,l=(e,o,c,t)=>{for(var a=t>1?void 0:t?u(o,c):o,r=e.length-1,s;r>=0;r--)(s=e[r])&&(a=(t?s(o,c,a):s(a))||a);return t&&a&&m(o,c,a),a};let i=class extends d{constructor(){super()}async _showUrlParameters(){const e=location.search;if(console.log(e),e.trim()){this._msg.innerHTML=`
        search: ${e}, \u6210\u529F\u8C03\u7528
      `;let o=e.replace("?pwadev=web%2Bpwadev%3A%2F%2F","");o=o.slice(0,-2),console.log(o),console.log(`https://restapi.amap.com/v3/geocode/geo?address=${o}&output=JSON&key=39a5a5f5239a28b739e6a79381afb97e`);const t=await(await fetch(`https://restapi.amap.com/v3/geocode/geo?address=${o}&output=JSON&key=39a5a5f5239a28b739e6a79381afb97e`)).json();console.log(t);let a=t.geocodes;console.log(a);let r=a[0].location;this._geolocation.innerHTML=r;const s=await fetch(`https://restapi.amap.com/v3/staticmap?location=${r}&zoom=10&size=375*250&markers=mid,,A:${r}&key=39a5a5f5239a28b739e6a79381afb97e`);this._map.innerHTML=`<img src="${s}">`}else this._msg.innerHTML="\u65E0 web+pwadev://* \u8C03\u7528"}_updateUph(){let e=`web+pwadev://${this._iuph.value}`;this._uph.innerHTML=e,this._uph.href=e}async connectedCallback(){super.connectedCallback(),setTimeout(()=>{this._showUrlParameters()},3e3)}static get styles(){return p`
    .about {
      padding: 0 16px;
...
//# sourceMappingURL=sample-uph.6e9ad9e3.js.map
