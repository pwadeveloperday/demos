 ...
 */class Ue extends Pn{constructor(e){if(super(e),this.it=b,e.type!==An.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===b||e==null)return this.ft=void 0,this.it=e;if(e===R)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ue.directiveName="unsafeHTML",Ue.resultType=1;const $=Cn(Ue);var Ln=Object.defineProperty,xn=Object.getOwnPropertyDescriptor,Ve=(r,e,t,n)=>{for(var i=n>1?void 0:n?xn(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&Ln(e,t,i),i};let oe=class extends v{constructor(){super(),this.enableBack=!1,this.svg=`
  ...
  `}static get styles(){return m`
    ...
    `}constructor(){super()}firstUpdated(){var e;new S((e=this.shadowRoot)==null?void 0:e.querySelector("#routerOutlet")).setRoutes([{path:"",animate:!0,children:[{path:"/",component:"app-home"},{path:"/about",component:"app-about",action:async()=>{await w(()=>import("./app-about.f22b56bc.js"),[])}},{path:"/sample/notification",component:"sample-n",action:async()=>{await w(()=>import("./sample-n.d63de4fa.js"),[])}},{path:"/sample/url-protocol-handler",component:"sample-uph",action:async()=>{await w(()=>import("./sample-uph.afe3cbde.js"),["code/sample-uph.afe3cbde.js","code/query.0830c8af.js"])}},{path:"/sample/wake-lock",component:"sample-swl",action:async()=>{await w(()=>import("./sample-swl.166a51aa.js"),["code/sample-swl.166a51aa.js","code/query.0830c8af.js"])}},{path:"/sample/async-clipboard",component:"sample-ac",action:async()=>{await w(()=>import("./sample-ac.b0b53a72.js"),["code/sample-ac.b0b53a72.js","code/query.0830c8af.js"])}},{path:"/sample/contact-picker",component:"sample-c",action:async()=>{await w(()=>import("./sample-c.064e1a53.js"),["code/sample-c.064e1a53.js","code/query.0830c8af.js"])}},{path:"/sample/generic-sensor",component:"sample-gs",action:async()=>{await w(()=>import("./sample-gs.0fbfc907.js"),["code/sample-gs.0fbfc907.js","code/query.0830c8af.js"])}},{path:"/sample/shape-detection",component:"sample-sd",action:async()=>{await w(()=>import("./sample-sd.f405325b.js"),["code/sample-sd.f405325b.js","code/query.0830c8af.js"])}},{path:"/sample/app-shortcuts",component:"sample-as",action:async()=>{await w(()=>import("./sample-as.553c2a96.js"),[])}},{path:"/sample/badging",component:"sample-b",action:async()=>{await w(()=>import("./sample-b.24fd8e1e.js"),["code/sample-b.24fd8e1e.js","code/query.0830c8af.js"])}},{path:"/sample/eyedropper",component:"sample-ed",action:async()=>{await w(()=>import("./sample-ed.9b560a77.js"),["code/sample-ed.9b560a77.js","code/query.0830c8af.js"])}},{path:"/sample/window-controls-overlay",component:"sample-wco",action:async()=>{await w(()=>import("./sample-wco.c7928b2b.js"),["code/sample-wco.c7928b2b.js","code/query.0830c8af.js"])}},{path:"/sample/web-share",component:"sample-ws",action:async()=>{await w(()=>import("./sample-ws.f03ff6d7.js"),["code/sample-ws.f03ff6d7.js","code/query.0830c8af.js"])}},{path:"/sample/local-font-access",component:"sample-lfa",action:async()=>{await w(()=>import("./sample-lfa.85c2bb49.js"),["code/sample-lfa.85c2bb49.js","code/query.0830c8af.js"])}},{path:"/sample/file-handling",component:"sample-fh",action:async()=>{await w(()=>import("./sample-fh.2f547db2.js"),["code/sample-fh.2f547db2.js","code/query.0830c8af.js"])}},{path:"/sample/media-player",component:"sample-mp",action:async()=>{await w(()=>import("./sample-mp.f6f85c0b.js"),["code/sample-mp.f6f85c0b.js","code/lit-video.6fc33520.js","code/query.0830c8af.js"])}},{path:"/sample/file-system-access",component:"sample-fsa",action:async()=>{await w(()=>import("./sample-fsa.3bb8519d.js"),["code/sample-fsa.3bb8519d.js","code/lit-video.6fc33520.js","code/query.0830c8af.js"])}},{path:"/sample/navigation",component:"sample-na",action:async()=>{await w(()=>import("./sample-na.f2a965b8.js"),["code/sample-na.f2a965b8.js","code/query.0830c8af.js"])}},{path:"/code-of-conduct",component:"app-coc",action:async()=>{await w(()=>import("./app-coc.b3fb7cd0.js"),[])}},{path:"/privacy",component:"app-privacy",action:async()=>{await w(()=>import("./app-privacy.b2100f43.js"),[])}}]}]),mn({immediate:!0})}render(){return g`
...
//# sourceMappingURL=index.1436422e.js.map
