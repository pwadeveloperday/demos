import{s,r as l,$ as g,n as p}from"./index.208603bb.js";import{i as b}from"./query.0830c8af.js";var u=Object.defineProperty,m=Object.getOwnPropertyDescriptor,c=(e,a,i,t)=>{for(var r=t>1?void 0:t?m(a,i):a,o=e.length-1,n;o>=0;o--)(n=e[o])&&(r=(t?n(a,i,r):n(r))||r);return t&&r&&u(a,i,r),r};let d=class extends s{constructor(){super()}_randomIntFromInterval(e,a){return Math.floor(Math.random()*(a-e+1)+e)}_unreadCountChanged(e){navigator.setAppBadge&&(this._msg.innerHTML="\u652F\u6301 Badging API",navigator.setAppBadge(e).then(()=>{this._msg.innerHTML=e+" \u5E94\u7528\u5FBD\u7AE0\uFF08Badge\uFF09\u6DFB\u52A0\u6210\u529F"}).catch(a=>{this._msg.innerHTML=a.name+" "+a.message}))}_b(){let e=this._randomIntFromInterval(1,999);this._unreadCountChanged(e)}_bc(){navigator.clearAppBadge().then(()=>{this._msg.innerHTML="\u5E94\u7528\u5FBD\u7AE0\uFF08Badge\uFF09\u5DF2\u6E05\u9664"}).catch(e=>{this._msg.innerHTML=e.name+" "+e.message})}async connectedCallback(){super.connectedCallback()}static get styles(){return l`
    ...
    `}};c([b("#msg")],d.prototype,"_msg",2);d=c([p("sample-b")],d);export{d as SampleB};
//# sourceMappingURL=sample-b.c53ce91b.js.map
