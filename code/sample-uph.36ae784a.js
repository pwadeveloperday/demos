import{s as d,r as p,$ as h,n as g}from"./index.208603bb.js";import{i as l}from"./query.0830c8af.js";var m=Object.defineProperty,u=Object.getOwnPropertyDescriptor,i=(e,a,c,n)=>{for(var o=n>1?void 0:n?u(a,c):a,t=e.length-1,s;t>=0;t--)(s=e[t])&&(o=(n?s(a,c,o):s(o))||o);return n&&o&&m(a,c,o),o};let r=class extends d{constructor(){super()}async _showUrlParameters(){const e=location.search;if(console.log(e),e.trim()){this._msg.innerHTML=`
        search: ${e}, \u6210\u529F\u8C03\u7528
      `;let a=e.replace("?pwadev=web%2Bpwadev%3A%2F%2F","");a=a.slice(0,-2);let t=(await(await fetch(`https://restapi.amap.com/v3/geocode/geo?address=${a}&output=JSON&key=39a5a5f5239a28b739e6a79381afb97e`)).json()).geocodes[0].location;this._geolocation.innerHTML=t;const s=await fetch(`https://restapi.amap.com/v3/staticmap?location=${t}&zoom=10&size=375*250&markers=mid,,A:${t}&key=39a5a5f5239a28b739e6a79381afb97e`);this._map.innerHTML=`<img src="${s}">`}else this._msg.innerHTML="\u65E0 web+pwadev://* \u8C03\u7528"}_updateUph(){let e=`web+pwadev://${this._iuph.value}`;this._uph.innerHTML=e,this._uph.href=e}async connectedCallback(){super.connectedCallback(),setTimeout(()=>{this._showUrlParameters()},3e3)}static get styles(){return p`
    .about {
      padding: 0 16px;
    ...
    `}};i([l("#msg")],r.prototype,"_msg",2);i([l("#uph")],r.prototype,"_uph",2);i([l("#iuph")],r.prototype,"_iuph",2);i([l("#geolocation")],r.prototype,"_geolocation",2);i([l("#map")],r.prototype,"_map",2);r=i([g("sample-uph")],r);export{r as SampleUPH};
//# sourceMappingURL=sample-uph.36ae784a.js.map
