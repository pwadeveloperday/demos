import{s as l,r as p,$ as g,n as b}from"./index.2b7fdb08.js";import{i as d}from"./query.0830c8af.js";var m=Object.defineProperty,u=Object.getOwnPropertyDescriptor,c=(e,a,t,o)=>{for(var i=o>1?void 0:o?u(a,t):a,s=e.length-1,n;s>=0;s--)(n=e[s])&&(i=(o?n(a,t,i):n(i))||i);return o&&i&&m(a,t,i),i};let r=class extends l{constructor(){super()}async _loadBlob(e){return await(await fetch(e)).blob()}async _copy(){try{const e="https://pwadev.io/assets/sample/pwa-fugu.png",a=await this._loadBlob(e),t=new ClipboardItem({"image/png":a});await navigator.clipboard.write([t]),this._msg.innerHTML="\u56FE\u7247\u5DF2\u590D\u5236"}catch(e){this._msg.innerHTML=e.message}}async _paste(){try{const e=await navigator.clipboard.read();console.log(e);const a=await e[0].getType("image/png");this._p.innerHTML=`
...
//# sourceMappingURL=sample-ac.6a49d7cf.js.map
