 ...
 */class Ue extends Pn{constructor(e){if(super(e),this.it=b,e.type!==An.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===b||e==null)return this.ft=void 0,this.it=e;if(e===R)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ue.directiveName="unsafeHTML",Ue.resultType=1;const $=Cn(Ue);var Ln=Object.defineProperty,xn=Object.getOwnPropertyDescriptor,Ve=(r,e,t,n)=>{for(var i=n>1?void 0:n?xn(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&Ln(e,t,i),i};let oe=class extends v{constructor(){super(),this.enableBack=!1,this.svg=`
  ...
  `}static get styles(){return m`
    ...
    `}constructor(){super()}firstUpdated(){var e;new S((e=this.shadowRoot)==null?void 0:e.querySelector("#routerOutlet")).setRoutes([{path:"",animate:!0,children:[{path:"/",component:"app-home"},{path:"/about",component:"app-about",action:async()=>{await w(()=>import("./app-about.1ffed3c8.js"),[])}},{path:"/sample/notification",component:"sample-n",action:async()=>{await w(()=>import("./sample-n.153ffb72.js"),[])}},{path:"/sample/url-protocol-handler",component:"sample-uph",action:async()=>{await w(()=>import("./sample-uph.36ae784a.js"),["code/sample-uph.36ae784a.js","code/query.0830c8af.js"])}},{path:"/sample/wake-lock",component:"sample-swl",action:async()=>{await w(()=>import("./sample-swl.3dbd528b.js"),["code/sample-swl.3dbd528b.js","code/query.0830c8af.js"])}},{path:"/sample/async-clipboard",component:"sample-ac",action:async()=>{await w(()=>import("./sample-ac.18217f3b.js"),["code/sample-ac.18217f3b.js","code/query.0830c8af.js"])}},{path:"/sample/contact-picker",component:"sample-c",action:async()=>{await w(()=>import("./sample-c.1b6507de.js"),["code/sample-c.1b6507de.js","code/query.0830c8af.js"])}},{path:"/sample/generic-sensor",component:"sample-gs",action:async()=>{await w(()=>import("./sample-gs.40d26a96.js"),["code/sample-gs.40d26a96.js","code/query.0830c8af.js"])}},{path:"/sample/shape-detection",component:"sample-sd",action:async()=>{await w(()=>import("./sample-sd.bb53e521.js"),["code/sample-sd.bb53e521.js","code/query.0830c8af.js"])}},{path:"/sample/app-shortcuts",component:"sample-as",action:async()=>{await w(()=>import("./sample-as.4a217479.js"),[])}},{path:"/sample/badging",component:"sample-b",action:async()=>{await w(()=>import("./sample-b.c53ce91b.js"),["code/sample-b.c53ce91b.js","code/query.0830c8af.js"])}},{path:"/sample/eyedropper",component:"sample-ed",action:async()=>{await w(()=>import("./sample-ed.ea72d31a.js"),["code/sample-ed.ea72d31a.js","code/query.0830c8af.js"])}},{path:"/sample/window-controls-overlay",component:"sample-wco",action:async()=>{await w(()=>import("./sample-wco.a2691a17.js"),["code/sample-wco.a2691a17.js","code/query.0830c8af.js"])}},{path:"/sample/web-share",component:"sample-ws",action:async()=>{await w(()=>import("./sample-ws.1010643b.js"),["code/sample-ws.1010643b.js","code/query.0830c8af.js"])}},{path:"/sample/local-font-access",component:"sample-lfa",action:async()=>{await w(()=>import("./sample-lfa.612001fb.js"),["code/sample-lfa.612001fb.js","code/query.0830c8af.js"])}},{path:"/sample/file-handling",component:"sample-fh",action:async()=>{await w(()=>import("./sample-fh.456c1a03.js"),["code/sample-fh.456c1a03.js","code/query.0830c8af.js"])}},{path:"/sample/media-player",component:"sample-mp",action:async()=>{await w(()=>import("./sample-mp.2c80ef72.js"),["code/sample-mp.2c80ef72.js","code/lit-video.6fc33520.js","code/query.0830c8af.js"])}},{path:"/sample/file-system-access",component:"sample-fsa",action:async()=>{await w(()=>import("./sample-fsa.1ffc04d3.js"),["code/sample-fsa.1ffc04d3.js","code/lit-video.6fc33520.js","code/query.0830c8af.js"])}},{path:"/sample/navigation",component:"sample-na",action:async()=>{await w(()=>import("./sample-na.beda099d.js"),["code/sample-na.beda099d.js","code/query.0830c8af.js"])}},{path:"/code-of-conduct",component:"app-coc",action:async()=>{await w(()=>import("./app-coc.9780dab0.js"),[])}},{path:"/privacy",component:"app-privacy",action:async()=>{await w(()=>import("./app-privacy.c117ebe9.js"),[])}}]}]),mn({immediate:!0})}render(){return g`
...
//# sourceMappingURL=index.208603bb.js.map
