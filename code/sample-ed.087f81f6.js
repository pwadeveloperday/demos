import{s as l,r as d,$ as p,e as b,n as g}from"./index.35101019.js";import{i as m}from"./query.0830c8af.js";var u=Object.defineProperty,h=Object.getOwnPropertyDescriptor,c=(o,e,i,t)=>{for(var r=t>1?void 0:t?h(e,i):e,n=o.length-1,s;n>=0;n--)(s=o[n])&&(r=(t?s(e,i,r):s(r))||r);return t&&r&&u(e,i,r),r};let a=class extends l{constructor(){super(),this.abortController=new AbortController}async _sampleColorFromScreen(){this.abortController=new AbortController;const o=new EyeDropper;try{const e=await o.open({signal:this.abortController.signal});this._msg.innerHTML=e.sRGBHex,this._msg.setAttribute("style","background: "+e.sRGBHex)}catch(e){this._msg.innerHTML=e.message}}_abort(){this._msg.innerHTML="\u5DF2\u53D6\u6D88",this._msg.setAttribute("style","background: none"),this.abortController.abort()}async connectedCallback(){super.connectedCallback()}static get styles(){return d`
    ...
    `}};c([m("#msg")],a.prototype,"_msg",2);c([b({type:Object})],a.prototype,"abortController",2);a=c([g("sample-ed")],a);export{a as SampleED};
//# sourceMappingURL=sample-ed.087f81f6.js.map
