import{s as p,r as g,$ as b,e as d,n as u}from"./index.7f676e3b.js";import{i as l}from"./query.0830c8af.js";var m=Object.defineProperty,h=Object.getOwnPropertyDescriptor,i=(e,a,o,c)=>{for(var t=c>1?void 0:c?h(a,o):a,n=e.length-1,s;n>=0;n--)(s=e[n])&&(t=(c?s(a,o,t):s(t))||t);return c&&t&&m(a,o,t),t};let r=class extends p{constructor(){super()}async _bc(){if((!("BarcodeDetector"in window)||!(await BarcodeDetector.getSupportedFormats()).includes("qr_code"))&&(this._msg.innerHTML="\u8BE5\u7CFB\u7EDF\u4E0D\u652F\u6301\u4E8C\u7EF4\u7801\u68C0\u6D4B"),this.stream=await navigator.mediaDevices.getUserMedia({video:{facingMode:{ideal:"environment"}},audio:!1}),this._video.srcObject=this.stream,await this._video.play(),this._video)try{let a=await new BarcodeDetector({formats:["qr_code"]}).detect(this._video);this._msg.innerHTML=a.map(o=>o.rawValue)}catch(e){this._msg.innerHTML=e.message}}async _pausec(){this._video.pause(),this.stream.getTracks().forEach(function(e){e.stop()})}async connectedCallback(){super.connectedCallback()}static get styles(){return g`
    .about {
      padding: 0 16px;
    ...
    `}};i([l("#stream")],r.prototype,"_video",2);i([l("#msg")],r.prototype,"_msg",2);i([d({type:Function})],r.prototype,"interval",2);i([d({type:Function})],r.prototype,"stream",2);r=i([u("sample-sd")],r);export{r as SampleSD};
//# sourceMappingURL=sample-sd.ff333274.js.map
