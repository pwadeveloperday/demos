 ...
 */class Ue extends Pn{constructor(e){if(super(e),this.it=b,e.type!==An.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===b||e==null)return this.ft=void 0,this.it=e;if(e===R)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this.ft;this.it=e;const t=[e];return t.raw=t,this.ft={_$litType$:this.constructor.resultType,strings:t,values:[]}}}Ue.directiveName="unsafeHTML",Ue.resultType=1;const $=Cn(Ue);var Ln=Object.defineProperty,xn=Object.getOwnPropertyDescriptor,Ve=(r,e,t,n)=>{for(var i=n>1?void 0:n?xn(e,t):e,s=r.length-1,o;s>=0;s--)(o=r[s])&&(i=(n?o(e,t,i):o(i))||i);return n&&i&&Ln(e,t,i),i};let oe=class extends v{constructor(){super(),this.enableBack=!1,this.svg=`
  ...
  `}static get styles(){return m`
    ...
    `}constructor(){super()}firstUpdated(){var e;new S((e=this.shadowRoot)==null?void 0:e.querySelector("#routerOutlet")).setRoutes([{path:"",animate:!0,children:[{path:"/",component:"app-home"},{path:"/about",component:"app-about",action:async()=>{await w(()=>import("./app-about.5579668b.js"),[])}},{path:"/sample/notification",component:"sample-n",action:async()=>{await w(()=>import("./sample-n.21e22ab2.js"),[])}},{path:"/sample/url-protocol-handler",component:"sample-uph",action:async()=>{await w(()=>import("./sample-uph.8d58eb0f.js"),["code/sample-uph.8d58eb0f.js","code/query.0830c8af.js"])}},{path:"/sample/wake-lock",component:"sample-swl",action:async()=>{await w(()=>import("./sample-swl.9281ae29.js"),["code/sample-swl.9281ae29.js","code/query.0830c8af.js"])}},{path:"/sample/async-clipboard",component:"sample-ac",action:async()=>{await w(()=>import("./sample-ac.815758cd.js"),["code/sample-ac.815758cd.js","code/query.0830c8af.js"])}},{path:"/sample/contact-picker",component:"sample-c",action:async()=>{await w(()=>import("./sample-c.6ff22996.js"),["code/sample-c.6ff22996.js","code/query.0830c8af.js"])}},{path:"/sample/generic-sensor",component:"sample-gs",action:async()=>{await w(()=>import("./sample-gs.f91a4eb3.js"),["code/sample-gs.f91a4eb3.js","code/query.0830c8af.js"])}},{path:"/sample/shape-detection",component:"sample-sd",action:async()=>{await w(()=>import("./sample-sd.9db0d624.js"),["code/sample-sd.9db0d624.js","code/query.0830c8af.js"])}},{path:"/sample/app-shortcuts",component:"sample-as",action:async()=>{await w(()=>import("./sample-as.91b36d10.js"),[])}},{path:"/sample/badging",component:"sample-b",action:async()=>{await w(()=>import("./sample-b.097fe6a4.js"),["code/sample-b.097fe6a4.js","code/query.0830c8af.js"])}},{path:"/sample/eyedropper",component:"sample-ed",action:async()=>{await w(()=>import("./sample-ed.7bc5474d.js"),["code/sample-ed.7bc5474d.js","code/query.0830c8af.js"])}},{path:"/sample/window-controls-overlay",component:"sample-wco",action:async()=>{await w(()=>import("./sample-wco.5049b822.js"),["code/sample-wco.5049b822.js","code/query.0830c8af.js"])}},{path:"/sample/web-share",component:"sample-ws",action:async()=>{await w(()=>import("./sample-ws.0dc699e9.js"),["code/sample-ws.0dc699e9.js","code/query.0830c8af.js"])}},{path:"/sample/local-font-access",component:"sample-lfa",action:async()=>{await w(()=>import("./sample-lfa.a8b1e43f.js"),["code/sample-lfa.a8b1e43f.js","code/query.0830c8af.js"])}},{path:"/sample/file-handling",component:"sample-fh",action:async()=>{await w(()=>import("./sample-fh.837fccee.js"),["code/sample-fh.837fccee.js","code/query.0830c8af.js"])}},{path:"/sample/media-player",component:"sample-mp",action:async()=>{await w(()=>import("./sample-mp.e904001d.js"),["code/sample-mp.e904001d.js","code/lit-video.6fc33520.js","code/query.0830c8af.js"])}},{path:"/sample/file-system-access",component:"sample-fsa",action:async()=>{await w(()=>import("./sample-fsa.56646ade.js"),["code/sample-fsa.56646ade.js","code/lit-video.6fc33520.js","code/query.0830c8af.js"])}},{path:"/sample/navigation",component:"sample-na",action:async()=>{await w(()=>import("./sample-na.060df465.js"),["code/sample-na.060df465.js","code/query.0830c8af.js"])}},{path:"/code-of-conduct",component:"app-coc",action:async()=>{await w(()=>import("./app-coc.5d08f6e3.js"),[])}},{path:"/privacy",component:"app-privacy",action:async()=>{await w(()=>import("./app-privacy.1b7029d0.js"),[])}}]}]),mn({immediate:!0})}render(){return g`
...
//# sourceMappingURL=index.f9c4bfbf.js.map
