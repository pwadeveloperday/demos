import{s as c,r as p,$ as u,n as h}from"./index.aa424184.js";import{i}from"./query.0830c8af.js";var g=Object.defineProperty,m=Object.getOwnPropertyDescriptor,r=(e,t,n,l)=>{for(var o=l>1?void 0:l?m(t,n):t,d=e.length-1,s;d>=0;d--)(s=e[d])&&(o=(l?s(t,n,o):s(o))||o);return l&&o&&g(t,n,o),o};let a=class extends c{constructor(){super()}async _showUrlParameters(){const e=location.search;console.log(e),e.trim()?this._msg.innerHTML="\u9AD8\u5FB7\u5730\u56FE\u514D\u8D39\u8C03\u7528\u91CF\u8D85\u9650\uFF0C\u6682\u505C\u8BE5\u6F14\u793A":this._msg.innerHTML="\u65E0 web+pwadev://* \u8C03\u7528<br>\u9AD8\u5FB7\u5730\u56FE\u514D\u8D39\u8C03\u7528\u91CF\u8D85\u9650\uFF0C\u6682\u505C\u8BE5\u6F14\u793A"}_updateUph(){let e=`web+pwadev://${this._iuph.value}`;this._uph.innerHTML=e,this._uph.href=e}async connectedCallback(){super.connectedCallback(),setTimeout(()=>{this._showUrlParameters()},3e3)}static get styles(){return p`
    .about {
      padding: 0 16px;
    ...
    `}};r([i("#msg")],a.prototype,"_msg",2);r([i("#uph")],a.prototype,"_uph",2);r([i("#iuph")],a.prototype,"_iuph",2);r([i("#geolocation")],a.prototype,"_geolocation",2);r([i("#map")],a.prototype,"_map",2);a=r([h("sample-uph")],a);export{a as SampleUPH};
//# sourceMappingURL=sample-uph.9663ca89.js.map
