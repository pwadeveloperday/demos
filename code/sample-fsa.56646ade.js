import{s as l,r as d,$ as p,n as g}from"./index.f9c4bfbf.js";import"./lit-video.6fc33520.js";import{i as m}from"./query.0830c8af.js";var b=Object.defineProperty,v=Object.getOwnPropertyDescriptor,n=(t,i,o,a)=>{for(var e=a>1?void 0:a?v(i,o):i,r=t.length-1,c;r>=0;r--)(c=t[r])&&(e=(a?c(i,o,e):c(e))||e);return a&&e&&b(i,o,e),e};let s=class extends l{constructor(){super()}async _playLocalVideo(){let t;[t]=await showOpenFilePicker();const i=await t.getFile();this.video.src=URL.createObjectURL(i)}async connectedCallback(){super.connectedCallback()}static get styles(){return d`
    ...
    `}};n([m("#first-video")],s.prototype,"video",2);s=n([g("sample-fsa")],s);export{s as SampleFSA};
//# sourceMappingURL=sample-fsa.56646ade.js.map
